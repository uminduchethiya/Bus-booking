    ...
    <div class="flex justify-center bg-gray-200">
        <div class="z-10 flex self-center justify-center my-10">
            <div class="p-12 mx-auto bg-white rounded-2xl w-100">
                <div class="mb-4">
                    <h3 class="mb-5 text-3xl font-semibold text-center text-blue-500">Edit User</h3>
                </div>
                @if(session('success'))
                        ...
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" id="first_name" name="f_name" value="{{$user->f_name}}"
                            ...
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" id="last_name" name="l_name" value="{{$user->l_name}}"
                                        class="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none focus:border-indigo-500"
                            ...
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <select id="roll" name="user_role"
                                        class="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none focus:border-indigo-500">
                                        <option value="admin" class="text-gray-400" @if($user->user_role == 'admin') selected @endif>Admin</option>
                                        <option value="user" class="text-gray-400" @if($user->user_role == 'user') selected @endif>User</option>
                                    </select>
                                </div>
                            </div>
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <select id="user_status" name="user_status"
                                        class="w-full py-2 pl-10 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none focus:border-indigo-500">
                                        <option value="Active" class="text-gray-400" @if($user->user_status == 'Active') selected @endif>Active</option>
                                        <option value="Inactive" class="text-gray-400" @if($user->user_status == 'Inactive') selected @endif>Inactive</option>
                                        <option value="Disable" class="text-gray-400" @if($user->user_status == 'Disable') selected @endif>Disable</option>
                                    </select>
                                </div>
                            </div>
                        </div>
