        ...
        <div class="justify-center min-h-screen col-span-2 mx-0 sm:flex sm:flex-row">
            <div class="z-10 flex flex-col self-center p-10 sm:max-w-5xl xl:max-w-2xl">
                <div class="flex-col self-start justify-center hidden text-white lg:flex">
                    <img src="" class="mb-3">
                    <a title="" href="{{ route('user.home') }}" target="_blank"
            ...
            <div class="z-10 flex self-center justify-center">
                <div class="w-full p-12  h-[300px] bg-white rounded-2xl ">
                    <div class="mb-4">
                        <h3 class="text-2xl font-semibold text-gray-800">Forget Password </h3>
                        <p class="text-gray-500">Please sign in to your account.</p>
                    </div>
                    <form action="{{ route('forgetpasswordPost') }}" method="post" class="space-y-5 w-full">
                        @csrf
                        <div class="space-y-2">
                        ...
                        <div class="flex -mx-3 text-center mt-5">
                            <button type="submit"
                            class=" w-full px-20 py-2 justify-center text-black bg-primaryColor rounded-3xl mt-5 font-boogaloo md:text-sm font-bold bg-buttonorange">CONTINUE
                        </button>
                        </div>
